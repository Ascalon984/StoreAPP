  ...
  return (
    <div className="flex-shrink-0 flex items-center gap-3 px-4 py-3 bg-[#048750] shadow-sm">
      ...
      <div className="relative flex-shrink-0">
        <div className="w-8 h-8 rounded-full bg-emerald-100 flex items-center justify-center shadow-sm border border-white/20">
          <span className="text-emerald-700 font-black text-xs leading-none">
            CS
          </span>
        </div>
        {isOnline && (
      ...
      <div className="flex-1 min-w-0">
        ...
        <p className="text-[10px] text-white/60 font-medium mt-2 leading-none">
